# Ananthajothi_B51BEE63BBA3890859D418DD7CCC8790
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-color: #55ff58bc;
        }

        header {
            background-color: #6af5ffda;
            color: #0031be;
            text-align: center;
            padding: 2rem 0;
...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="content://com.android.providers.media.documents/document/image%3A1000053644" alt="Your Profile Picture" class="profile-picture">
            <h1>ANANTHA JOTHI A</h1>
